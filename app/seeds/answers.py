...
def seed_answers():
    ...
    answer_01 = Answer(answer='CHLOROPHYLL!!!!', user_id=2, question_id=1)
    answer_02 = Answer(answer='I believe it is because plants contain a pigment called chlorophyll which helps the plant absorb sun. The chlorophyll absorbs light but reflects green light so it appears green.', user_id=3, question_id=1)
    answer_03 = Answer(answer='GIVE TREATS!!!', user_id=2, question_id=2)
